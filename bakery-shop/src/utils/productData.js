...
export const localProducts = [
  { _id: "1", title: "Black Forest Cake", image: blackForest, category: "Cakes", price: 549, isFeatured: true },
  { _id: "2", title: "Blueberry Cheesecake", image: blueberryCheese, category: "Cakes", price: 699, isFeatured: true },
  ...
  { _id: "7", title: "Chocolate Truffle", image: choctuffle, category: "Cakes", price: 499, isFeatured: true },
  { _id: "8", title: "Cream Roll", image: creamRoll, category: "Bread", price: 49 },
  { _id: "9", title: "Doughnut", image: doughnut, category: "Cupcakes", price: 89 },
  { _id: "10", title: "French Croissant", image: frenchCroissant, category: "Bread", price: 119 },
  { _id: "11", title: "Garlic Bread", image: garlicBread, category: "Bread", price: 149, isFeatured: true },
...
export const featuredProducts = localProducts
...
export function normalizeProduct(product, index) {
  return {
    ...product,
    _id: String(product._id || product.id || index + 1),
    title: product.title || product.name || "Bakery item",
    image: product.image || localProducts[index % localProducts.length].image,
